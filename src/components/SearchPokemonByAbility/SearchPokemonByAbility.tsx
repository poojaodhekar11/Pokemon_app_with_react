...
const SearchPokemonByAbility = (props:any) => {
  ...
  const handleSubmitForm = useCallback(
    (value) => {
      if (value) {
        dispatch(PokemonActions.searchPokeByAbility(value));
        return;
      }
        ...
        <form onSubmit={handleSubmit}>
          <div className='searchBox'>
            <TextField
              ...
              value={values.search}
              fullWidth
              placeholder="Search by ability name or ability number"
            />
          </div>
        </form>
      )}
...
export default SearchPokemonByAbility;
